...
node ${AGENT_SKILL_DIR:-$HOME/.agents/skills/obsidian-article-extractor}/extract-article.js <url>
...
node ${AGENT_SKILL_DIR:-$HOME/.agents/skills/obsidian-article-extractor}/extract-article.js "$ARTICLE_URL"
```
