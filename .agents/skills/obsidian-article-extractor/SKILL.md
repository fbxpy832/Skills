...
```bash
node ${AGENT_SKILL_DIR:-$HOME/.agents/skills/obsidian-article-extractor}/extract-article.js <url> [vaultPath] [inboxFolder]
```
...
```bash
node ${AGENT_SKILL_DIR:-$HOME/.agents/skills/obsidian-article-extractor}/extract-article.js \
...
```bash
node ${AGENT_SKILL_DIR:-$HOME/.agents/skills/obsidian-article-extractor}/extract-article.js "https://mp.weixin.qq.com/s/xxxxx"
```
