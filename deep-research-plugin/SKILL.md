...
description: Multi-host enterprise Deep Research protocol. A composable research decision workflow for business, government, technical, and investment analysis. Includes host-adapter contracts, search backend contracts, generic/opencode runners, eval harness, and event-driven progress tracking.
---
